...
namespace DotNetCoreKoans.Koans
{
    public class AboutArrays : Koan
    {
        ...
        public void SlicingArrays()
        {
            ...
            var array2 = array.Skip(1).Take(2);
            array[2] = "hello";
			Assert.Equal(new string[] { "butter", "hello" }, array2.ToArray());

            var array3 = array.Skip(1).Take(2).ToArray();
            array[2] = "and";
			Assert.Equal(new string[] { "butter", "hello" }, array3.ToArray());
        }
